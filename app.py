...
# Possible logo file names if saved locally
...
if is_surveyor_mode:
    # Hide sidebar completely for surveyor link
    st.markdown("""
        <style>
...
if active_file:
    try:
        ...
        # =====================================================================
        # HEADER WITH DRISHTI RED EYE LOGO (TOP LEFT)
        # =====================================================================
        ...
        with col_logo:
            if LOGO_PATH:
                ...
                # Fallback SVG Red Eye Icon if image file is not found
                st.markdown("""
