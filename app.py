...
# Saved Completed Surveys Load karna
...
if active_file:
    try:
        ...
        # =====================================================================
        # MODE 1: SURVEYOR MOBILE MODE (Sirf Survey Field View)
        # =====================================================================
                ...
                with st.form("dynamic_survey_form", clear_on_submit=False):
                    ...
                    for col_heading in df_he_columns:
                        ...
                        if head_lower in ["id"]:
                            ...
                            st.markdown("**📷 Dukaan ki Photo Khinchein**")
                            enable_cam = st.checkbox("Live Camera Kholne ke liye Tick Karein", key="cam_toggle")
                            if enable_cam:
                                form_values[head_clean] = st.camera_input("Photo Khinchein")
                            else:
                    ...
                    submitted = st.form_submit_button("Survey Submit Karein", use_container_width=True)
                    ...
                    if submitted:
                        ...
                        if img_col and not form_values.get(img_col):
                            st.error("⚠️ Photo capture karne ke liye 'Live Camera Kholne ke liye Tick Karein' par click karein.")
                        else:
                            ...
                            st.success(f"✅ '{st.session_state.selected_outlet}' ka survey successfully submit ho gaya!")
                            st.rerun()
        ...
        # =====================================================================
            ...
            # MAP FILTER CONTROLS FOR LAPTOP
    ...
    st.info("👈 Server folder me `master_questions.xlsx` file ka hona zaroori hai.")