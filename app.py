...
# Configuration & Setup
# -----------------------------------------------------------------------------
st.set_page_config(page_title="FMCG Live Survey & Admin Dashboard", layout="wide")
...
# -----------------------------------------------------------------------------
# Navigation Mode Selector (Sidebar)
# -----------------------------------------------------------------------------
st.sidebar.title("🎛️ Control Panel")
app_mode = st.sidebar.radio(
    "Select Interface Mode:",
    ["📱 Surveyor Mode (Mobile)", "🖥️ Admin Dashboard (Laptop Live)"]
)
...
if loc and 'coords' in loc:
    ...
    st.sidebar.warning("⏳ GPS Location detect ho raha hai...")

uploaded_master = st.sidebar.file_uploader(
    "Optionally Update Master Excel File (.xlsx)", 
    type=["xlsx"], 
...
if active_file:
    try:
        ...
        # Build Master Dropdowns Dictionary
        master_dropdowns = {}
        ...
        # =====================================================================
        if app_mode == "📱 Surveyor Mode (Mobile)":
            st.title("📱 FMCG Field Survey Portal")

            selected_hunter = st.sidebar.selectbox("👤 Select Your Name (Surveyor)", options=hunter_list)
            ...
            with col_left:
                ...
                if surveyor_lat and surveyor_lon:
                    folium.Marker(
                        ...
                        popup=f"Your Current Location ({selected_hunter})",
        ...
        # =====================================================================
        # MODE 2: ADMIN LIVE DASHBOARD (LAPTOP VIEW)
        # =====================================================================
        else:
            ...
            # MAP FILTER CONTROLS (LAPTOP DASHBOARD FILTER)
            ...
            # Filter data based on admin selection
            ...
            # Show Surveyor Live GPS Location on Map if available
            if surveyor_lat and surveyor_lon:
                folium.Marker(
                    [surveyor_lat, surveyor_lon],
            ...
            # Add Outlet Markers based on Status Filter
            ...
            # Surveyor-wise Progress Summary
    ...
    st.info("👈 Master file upload karein ya `master_questions.xlsx` ko server folder me rakhein.")