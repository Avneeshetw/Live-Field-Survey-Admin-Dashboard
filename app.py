...
# -----------------------------------------------------------------------------
# Check both st.query_params and experimental_get_query_params for compatibility
try:
...
if is_surveyor_mode:
    # SURVEYOR LINK MODE: Hide sidebar completely using CSS
    st.markdown("""
        <style>
...
if active_file:
    try:
        ...
        # =====================================================================
        # MODE 1: SURVEYOR MOBILE MODE (Link me ?mode=surveyor se khulega)
        # =====================================================================
        ...
        # =====================================================================
        # MODE 2: ADMIN LIVE DASHBOARD (Laptop View - Default Link)
        # =====================================================================
        else:
